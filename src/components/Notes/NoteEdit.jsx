...
export default function NoteEditor ({ id, initialText, onSave, onCancel }) {
    ...
    return (
        <div className="flex justify-center container max-w-4xl mx-auto px-15 py-8 shadow-xl m-3 rounded-md bg-white font-[400] text-[16px] font-[proxina_soft]">
            ...
            />
            <button className="border-1 border-gray-300 px-4 py-2.5 m-1 text-green-600 rounded-md hover:border-green-400" onClick={handleSave}>Save</button>
            <button className="border-1 border-gray-300 px-4 py-2.5 m-1 text-red-600 rounded-md hover:border-red-300" onClick={onCancel}>Cancel</button>
        </div>
    )
}